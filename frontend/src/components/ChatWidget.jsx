    ...
    const [messages, setMessages] = useState([
        {
            id: "welcome",
            role: "assistant",
            content: "👋 Bonjour ! Je suis l'assistant Suffelkopie. Comment puis-je vous aider ?",
            cached: false,
            rating: null
        }
    ])
                        ...
                        <div style={{
                            ...
                            {messages.map((msg) => (
                                <div key={msg.id}>
                                    ...
                                    {msg.role === "assistant" && !msg.typing && msg.id !== "welcome" && (
                                        <div style={{
                                            display: "flex", gap: "6px", marginTop: "4px",
                                            justifyContent: "flex-start", paddingLeft: "4px"
                                        }}>
                                            <button
                                                onClick={() => sendFeedback(msg.id, msg.question, msg.content, "positive")}
                                                style={{
                                                    background: msg.rating === "positive" ? "#dcfce7" : "#f3f4f6",
                                                    border: msg.rating === "positive" ? "1px solid #86efac" : "1px solid #e5e7eb",
                                            ...
                                            >👍</button>
                                            <button
                                                onClick={() => sendFeedback(msg.id, msg.question, msg.content, "negative")}
                                                style={{
                                                    background: msg.rating === "negative" ? "#fee2e2" : "#f3f4f6",
                                                    border: msg.rating === "negative" ? "1px solid #fca5a5" : "1px solid #e5e7eb",
                                                    borderRadius: "8px", padding: "2px 8px",
                                                    cursor: "pointer", fontSize: "14px",
                                                    transition: "all 0.2s"
                                                }}
